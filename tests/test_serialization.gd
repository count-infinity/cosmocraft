...
func test_encode_message_has_required_fields() -> void:
	var json_str := Serialization.encode_message("test_type", {"key": "value"})
...
func test_decode_message_valid_json() -> void:
	...
	var result := Serialization.decode_message(json_str)
...
func test_decode_message_invalid_json() -> void:
	var result := Serialization.decode_message("not valid json {{{")
...
func test_encode_connect_request() -> void:
	var json_str := Serialization.encode_connect_request("TestPlayer")
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_player_input() -> void:
	...
	var aim := 1.57
	var json_str := Serialization.encode_player_input(42, direction, aim, ["jump"])
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_ping() -> void:
	var json_str := Serialization.encode_ping()
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_connect_response_success() -> void:
	var json_str := Serialization.encode_connect_response(true, "player-123", 1000)
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_connect_response_failure() -> void:
	var json_str := Serialization.encode_connect_response(false, "", 0, "Server full")
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_game_state() -> void:
	...
	var json_str := Serialization.encode_game_state(500, players)
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_state_delta() -> void:
	...
	var json_str := Serialization.encode_state_delta(501, 42, players)
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_player_joined() -> void:
	...
	var json_str := Serialization.encode_player_joined(player)
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_player_left() -> void:
	var json_str := Serialization.encode_player_left("p2")
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_pong() -> void:
	var json_str := Serialization.encode_pong(12345)
	var parsed := Serialization.decode_message(json_str)
...
func test_encode_error() -> void:
	var json_str := Serialization.encode_error("Something went wrong")
	var parsed: Variant = Serialization.decode_message(json_str)
...
func test_parse_player_input() -> void:
	...
	var result := Serialization.parse_player_input(data)
...
func test_parse_player_input_defaults() -> void:
	var result := Serialization.parse_player_input({})
